...
var HeadlessB2BOAuthClient = /*#__PURE__*/function (_internal$HeadlessB2B) {
  ...
  function HeadlessB2BOAuthClient(_networkClient, _subscriptionService, _pkceManager, _dynamicConfig, _config) {
    ...
    _this.startOneTapDiscovery = function (options) {
      return internal.__awaiter(_assertThisInitialized(_this), void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
    ...
    _this.startOneTap = function (options) {
      return internal.__awaiter(_assertThisInitialized(_this), void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
        var clientResult, client, onSuccessCallback;
...
var CaptchaProvider = /*#__PURE__*/_createClass(function CaptchaProvider(bootstrapPromise) {
  ...
  this.executeRecaptcha = function () {
    return internal.__awaiter(_this3, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
  ...
  this.state = bootstrapPromise.then(function (bootstrapData) {
    return internal.__awaiter(_this3, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
...
var BaseSubscriptionService = /*#__PURE__*/function () {
  function BaseSubscriptionService(_publicToken, _datalayer) {
    ...
    this._listen = function (e) {
      if (e.key !== internal.getPersistentStorageKey(_this7._publicToken)) {
        return;
      }
...
var StytchB2BHeadlessClient = /*#__PURE__*/_createClass(function StytchB2BHeadlessClient(_PUBLIC_TOKEN, options) {
  ...
  this.sso = new internal.HeadlessB2BSSOClient(this._networkClient, this._subscriptionService, new PKCEManager(this._dataLayer, 'sso'), bootstrap.getAsync(), {
    publicToken: _PUBLIC_TOKEN,
    testAPIURL: config.endpoints.testAPIURL,
    liveAPIURL: config.endpoints.liveAPIURL
  }, dfpProtectedAuth);
  this.discovery = new internal.HeadlessB2BDiscoveryClient(this._networkClient, this._subscriptionService);
  this.passwords = new internal.HeadlessB2BPasswordsClient(this._networkClient, this._subscriptionService, passwordsPKCEManager, bootstrap.getAsync(), dfpProtectedAuth);
  this.otps = new internal.HeadlessB2BOTPsClient(this._networkClient, this._subscriptionService, dfpProtectedAuth);
