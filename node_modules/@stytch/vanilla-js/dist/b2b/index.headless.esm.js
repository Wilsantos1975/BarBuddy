...
import { ad as HeadlessB2BOAuthClient$1, d as __awaiter, f as OneTapPositions, a6 as StytchSDKUsageError, l as logger, ae as loadESModule, af as IframeHostClient, ac as getPersistentStorageKey, ag as validate, ah as hasMultipleCookies, ai as isLocalhost, aj as GOOGLE_ONE_TAP_HOST, ak as GOOGLE_ONE_TAP_SCRIPT_URL, i as isTestPublicToken, al as EventLogger, am as DEFAULT_MAX_BATCH_SIZE, an as DEFAULT_INTERVAL_DURATION_MS, ao as createEventId, ap as createAppSessionId, aq as createPersistentId, ar as baseFetchSDK, as as _retriableFetchSDK, at as checkB2BNotSSR, au as checkPublicToken, av as buildFinalConfig, aw as StateChangeClient, ax as DFPProtectedAuthProvider, ay as HeadlessB2BOrganizationClient, az as HeadlessB2BSelfClient, aA as HeadlessB2BSessionClient, aB as HeadlessB2BMagicLinksClient, aC as HeadlessB2BSSOClient, aD as HeadlessB2BDiscoveryClient, aE as HeadlessB2BPasswordsClient, aF as HeadlessB2BOTPsClient, aG as HeadlessB2BTOTPsClient, aH as HeadlessB2BRecoveryCodesClient, aI as HeadlessB2BRBACClient, aJ as HeadlessB2BSCIMClient, aK as SessionManager, aL as SearchDataManager, aM as writeB2BInternals } from '../internal-DhpbqDn_.js';
export { A as AuthFlowType, B as B2BMFAProducts, c as B2BOAuthProviders, a as B2BProducts, k as BiometricsFailedError, m as BiometricsUnavailableError, n as ChallengeSigningFailedError, o as DeviceCredentialsNotAllowedError, F as FailedCodeChallengeError, p as FailedToDecryptDataError, I as InternalError, q as InvalidAuthorizationCredentialError, s as InvalidCredentialTypeError, t as InvalidRedirectSchemeError, u as InvalidStartUrlError, J as JSONDataNotConvertibleToStringError, K as KeyInvalidatedError, v as KeystoreUnavailableError, M as MissingAttestationObjectError, w as MissingAuthorizationCredentialIDTokenError, x as MissingGoogleClientIDError, y as MissingPKCEError, z as MissingPublicKeyError, G as MissingUrlError, N as NoBiometricsEnrolledError, H as NoBiometricsRegistrationError, L as NoCredentialsPresentError, Q as NoCurrentSessionError, O as OAuthProviders, b as OTPMethods, T as PasskeysInvalidEncoding, U as PasskeysMisconfigured, V as PasskeysUnsupportedError, P as Products, X as RNUIProducts, Y as RandomNumberGenerationFailed, R as RedirectURLType, Z as SDKAPIUnreachableError, $ as SDKNotConfiguredError, a0 as SignInWithAppleMisconfigured, e as StytchAPIError, a1 as StytchAPISchemaError, a2 as StytchAPIUnreachableError, a3 as StytchError, S as StytchEventType, a4 as StytchSDKAPIError, h as StytchSDKError, a5 as StytchSDKSchemaError, a7 as UNRECOVERABLE_ERROR_TYPES, a8 as UserCancellationError, a9 as UserLockedOutError, W as Wallets, aa as errorToStytchError } from '../internal-DhpbqDn_.js';
    ...
    this.browserSessionStorage = {
      getItem: function getItem(key) {
        return safeSessionStorageOperation({
          operation: 'get',
          key: getPersistentStorageKey(_this5.publicToken, key)
        });
      },
...
var BaseSubscriptionService = /*#__PURE__*/function () {
  function BaseSubscriptionService(_publicToken, _datalayer) {
    ...
    this._listen = function (e) {
      if (e.key !== getPersistentStorageKey(_this7._publicToken)) {
        return;
      }
        ...
        return _regeneratorRuntime().wrap(function _callee18$(_context18) {
          while (1) switch (_context18.prev = _context18.next) {
            case 0:
              ...
              return _context18.abrupt("return", baseFetchSDK({
        ...
        return _regeneratorRuntime().wrap(function _callee19$(_context19) {
          while (1) switch (_context19.prev = _context19.next) {
            case 0:
              ...
              xSDKClientHeader = window.btoa(JSON.stringify(this.createTelemetryBlob()));
              xSDKParentHostHeader = window.location.origin;
              return _context19.abrupt("return", _retriableFetchSDK({
                basicAuthHeader: basicAuthHeader,
                body: body,
                finalURL: this.buildSDKUrl(url),
                method: method,
...
var StytchB2BHeadlessClient = /*#__PURE__*/_createClass(function StytchB2BHeadlessClient(_PUBLIC_TOKEN, options) {
  ...
  checkB2BNotSSR('StytchB2BHeadlessClient');
  ...
  this.organization = new HeadlessB2BOrganizationClient(this._networkClient, this._networkClient, this._subscriptionService);
  this.member = new HeadlessB2BSelfClient(this._networkClient, this._networkClient, this._subscriptionService);
  this.self = new HeadlessB2BSelfClient(this._networkClient, this._networkClient, this._subscriptionService);
  this.session = new HeadlessB2BSessionClient(this._networkClient, this._subscriptionService);
  this.magicLinks = new HeadlessB2BMagicLinksClient(this._networkClient, this._subscriptionService, new PKCEManager(this._dataLayer, 'magic_links'), passwordsPKCEManager, bootstrap.getAsync(), dfpProtectedAuth);
  ...
  this.sso = new HeadlessB2BSSOClient(this._networkClient, this._subscriptionService, new PKCEManager(this._dataLayer, 'sso'), bootstrap.getAsync(), {
    publicToken: _PUBLIC_TOKEN,
    testAPIURL: config.endpoints.testAPIURL,
    liveAPIURL: config.endpoints.liveAPIURL
  }, dfpProtectedAuth);
  this.discovery = new HeadlessB2BDiscoveryClient(this._networkClient, this._subscriptionService);
  this.passwords = new HeadlessB2BPasswordsClient(this._networkClient, this._subscriptionService, passwordsPKCEManager, bootstrap.getAsync(), dfpProtectedAuth);
  this.otps = new HeadlessB2BOTPsClient(this._networkClient, this._subscriptionService, dfpProtectedAuth);
  this.totp = new HeadlessB2BTOTPsClient(this._networkClient, this._subscriptionService, dfpProtectedAuth);
  this.recoveryCodes = new HeadlessB2BRecoveryCodesClient(this._networkClient, this._subscriptionService, dfpProtectedAuth);
...
export { OneTapPositions, StytchB2BHeadlessClient, StytchSDKUsageError };
