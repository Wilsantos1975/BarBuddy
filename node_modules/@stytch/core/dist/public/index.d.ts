...
interface IHeadlessB2BSessionClient {
     ...
     * If no active session is present, returns null.
     *
     * Note that the Stytch SDK stores the `session_token` and `session_jwt` values as session cookies in the user's browser.
     * Those cookies will be automatically included in any request that your frontend makes to a service (such as your backend) that shares the domain set on the cookies, so in most cases, you will not need to explicitly retrieve the `session_token` and `session_jwt` values using the `getTokens()` method.
...
type OrganizationBySlugMatch = Pick<Organization, "organization_id" | "sso_active_connections" | "organization_name" | "organization_logo_url" | "sso_default_connection_id" | "email_jit_provisioning" | "email_allowed_domains" | "oauth_tenant_jit_provisioning" | "allowed_oauth_tenants" | "auth_methods" | "allowed_auth_methods" | "mfa_policy">;
...
type B2BPasswordDiscoveryAuthenticateResponse = B2BDiscoveryOrganizationsResponse & {
    intermediate_session_token: string;
};
...
type B2BPasswordDiscoveryResetByEmailResponse = B2BDiscoveryOrganizationsResponse & {
    intermediate_session_token: string;
};
...
interface IHeadlessB2BPasswordClient {
    ...
    discovery: {
        /**
         * The resetByEmailDiscoveryStart method wraps the {@link https://stytch.com/docs/b2b/api/discovery-email-reset-start Reset By Email Discovery Start} Password API endpoint.
        ...
        /**
         * The discoveryResetByEmail method wraps the {@link https://stytch.com/docs/b2b/api/discovery-email-reset Reset By Email Discovery} Password API endpoint.
         ...
         * @throws A `StytchAPIUnreachableError` when the SDK cannot contact the Stytch API.
         */
        resetByEmail(options: B2BPasswordDiscoveryResetByEmailOptions): Promise<B2BPasswordDiscoveryResetByEmailResponse>;
        /**
         * The discoveryAuthenticate method wraps the {@link https://stytch.com/docs/b2b/api/passwords-discovery-authenticate Discovery Authenticate} Password API endpoint.
         ...
         * @throws A `StytchAPIUnreachableError` when the SDK cannot contact the Stytch API.
         */
        authenticate(options: B2BPasswordDiscoveryAuthenticateOptions): Promise<B2BPasswordDiscoveryAuthenticateResponse>;
    };
}
// SMS OTP
...
type B2BOTPsEmailAuthenticateResponse = B2BAuthenticateResponseWithMFA & {
    /**
...
type B2BDiscoveryOTPEmailAuthenticateResponse = B2BDiscoveryAuthenticateResponse;
interface IHeadlessB2BOTPsClient {
    ...
    email: {
         ...
         * @throws A `StytchSDKUsageError` when called with invalid input (invalid email, invalid options, etc.)
         */
        authenticate(data: B2BOTPsEmailAuthenticateOptions): Promise<B2BOTPsEmailAuthenticateResponse>;
        discovery: {
            /**
             ...
             * @throws A `StytchSDKUsageError` when called with invalid input (invalid email, invalid options, etc.)
             */
            authenticate(data: B2BDiscoveryOTPEmailAuthenticateOptions): Promise<B2BDiscoveryOTPEmailAuthenticateResponse>;
        };
    };
}
...
type B2BTOTPCreateResponse = ResponseCommon & {
    /**
     * Globally unique UUID that identifies a specific TOTP registration in the Stytch API.
     */
    totp_id: string;
...
type B2BTOTPAuthenticateResponse = B2BAuthenticateResponse;
interface IHeadlessB2BTOTPsClient {
    /**
     ...
     * @throws A `StytchSDKUsageError` when called with invalid input.
     */
    authenticate(data: B2BTOTPAuthenticateOptions): Promise<B2BTOTPAuthenticateResponse>;
    /**
...
type RecoveryCodeRecoverResponse = B2BAuthenticateResponse & {
    /**
...
interface IHeadlessB2BRecoveryCodesClient {
    /**
     ...
     * @throws A `StytchSDKUsageError` when called with invalid input.
     */
    recover(options: RecoveryCodeRecoverOptions): Promise<RecoveryCodeRecoverResponse>;
    /**
...
declare function errorToStytchError(error: Error): StytchSDKError;
type DeepPartial<K> = {
...
type StytchEventMap = {
    ...
    [StytchEventType.OTPsAuthenticate]: OTPsAuthenticateResponse;
    [StytchEventType.CryptoWalletAuthenticateStart]: CryptoWalletAuthenticateStartResponse;
    [StytchEventType.CryptoWalletAuthenticate]: CryptoWalletAuthenticateResponse;
    [StytchEventType.PasswordCreate]: PasswordCreateResponse;
    [StytchEventType.PasswordAuthenticate]: PasswordAuthenticateResponse;
    [StytchEventType.B2BPasswordDiscoveryAuthenticate]: B2BPasswordDiscoveryAuthenticateResponse;
    [StytchEventType.PasswordResetByEmailStart]: PasswordResetByEmailStartResponse;
    [StytchEventType.PasswordResetByEmail]: PasswordResetByEmailResponse;
    ...
    [StytchEventType.B2BMagicLinkAuthenticate]: B2BMagicLinksAuthenticateResponse;
    [StytchEventType.B2BMagicLinkEmailDiscoverySend]: B2BMagicLinksEmailDiscoverySendResponse;
    [StytchEventType.B2BMagicLinkDiscoveryAuthenticate]: B2BMagicLinksDiscoveryAuthenticateResponse;
    [StytchEventType.B2BSSOStart]: Record<string, never>;
    [StytchEventType.B2BSSOAuthenticate]: SSOAuthenticateResponse;
    [StytchEventType.B2BDiscoveryOrganizationsCreate]: B2BDiscoveryOrganizationsCreateResponse;
    [StytchEventType.B2BPasswordAuthenticate]: B2BPasswordAuthenticateResponse;
    [StytchEventType.B2BPasswordResetByEmailStart]: B2BPasswordResetByEmailStartResponse;
    [StytchEventType.B2BPasswordResetByEmail]: B2BPasswordResetByEmailResponse;
    [StytchEventType.B2BPasswordResetBySession]: B2BPasswordResetBySessionResponse;
    [StytchEventType.B2BDiscoveryIntermediateSessionExchange]: B2BDiscoveryIntermediateSessionsExchangeResponse;
    [StytchEventType.B2BOAuthAuthenticate]: B2BOAuthAuthenticateResponse;
    [StytchEventType.B2BOAuthDiscoveryAuthenticate]: B2BOAuthDiscoveryAuthenticateResponse;
    [StytchEventType.PasskeySkip]: Record<string, never>;
    [StytchEventType.PasskeyDone]: Record<string, never>;
    [StytchEventType.PasskeyRegister]: WebAuthnRegisterResponse;
    [StytchEventType.PasskeyAuthenticate]: WebAuthnAuthenticateResponse;
    [StytchEventType.B2BSMSOTPSend]: B2BSMSSendResponse;
    [StytchEventType.B2BSMSOTPAuthenticate]: B2BSMSAuthenticateResponse;
    [StytchEventType.B2BTOTPCreate]: B2BTOTPCreateResponse;
    [StytchEventType.B2BTOTPAuthenticate]: B2BTOTPAuthenticateResponse;
    [StytchEventType.B2BRecoveryCodesRecover]: RecoveryCodeRecoverResponse;
    [StytchEventType.B2BDiscoveryPasswordReset]: B2BPasswordDiscoveryResetByEmailResponse;
    [StytchEventType.B2BPasswordDiscoveryResetStart]: B2BPasswordDiscoveryResetByEmailStartResponse;
};
type StytchEvent = {
    [K in StytchEventType]: {
        type: K;
        data: StytchEventMap[K];
    };
}[keyof StytchEventMap];
/**
...
type BiometricsRegisterCompleteResponse = AuthenticateResponse & {
    /**
     * A unique ID that identifies a specific biometric registration.
     */
    biometric_registration_id: string;
...
type BiometricsAuthenticateCompleteResponse = AuthenticateResponse & {
    /**
     * A unique ID that identifies a specific biometric registration.
     */
    biometric_registration_id: string;
...
interface IHeadlessBiometricsClient {
    /**
     ...
     */
    register: (options: BiometricsRegisterOptions) => Promise<BiometricsRegisterCompleteResponse>;
    /**
     ...
     * @throws A `StytchSDKError` when the Stytch React Native module returns an error.
     */
    authenticate: (options: BiometricsAuthenticateOptions) => Promise<BiometricsAuthenticateCompleteResponse>;
    /**
