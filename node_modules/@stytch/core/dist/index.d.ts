...
declare class SubscriptionService<T extends ConsumerState | B2BState> implements ISubscriptionService<T> {
    ...
    destroyState(): void;
    destroySession(): void;
    _updateStateAndTokensInternal(stateDiff: StateWithTokensDiff<T>, fromCache: boolean): void;
    updateStateAndTokens(stateDiff: StateWithTokensDiff<T>, fromCache?: boolean): void;
...
declare class HeadlessUserClient implements IHeadlessUserClient {
    ...
    deleteCryptoWallet: (cryptoWalletId: string) => Promise<Omit<WithUser<UpdateResponse>, "__user">>;
...
declare class HeadlessCryptoWalletClient implements IHeadlessCryptoWalletClient {
    ...
    private dfpProtectedAuth;
    private _config;
    constructor(_networkClient: INetworkClient, _apiNetworkClient: INetworkClient, _subscriptionService: IConsumerSubscriptionService, executeRecaptcha: () => Promise<string | undefined>, dfpProtectedAuth: IDFPProtectedAuthProvider, _config?: DynamicConfig$1);
    authenticateStart(options: CryptoWalletAuthenticateStartOptions): Promise<CryptoWalletAuthenticateStartResponse>;
    authenticate(options: CryptoWalletAuthenticateOptions): Promise<CryptoWalletAuthenticateResponse>;
}
...
declare class HeadlessPasswordClient implements IHeadlessPasswordClient {
    ...
    private _config;
    private dfpProtectedAuth;
    constructor(_networkClient: INetworkClient, _subscriptionService: IConsumerSubscriptionService, _pkceManager: IPKCEManager, _config: DynamicConfig$2, dfpProtectedAuth: IDFPProtectedAuthProvider);
    private getCodeChallenge;
    create(options: PasswordCreateOptions): Promise<PasswordCreateResponse>;
    authenticate(options: PasswordAuthenticateOptions): Promise<PasswordAuthenticateResponse>;
    resetByEmailStart(options: PasswordResetByEmailStartOptions): Promise<PasswordResetByEmailStartResponse>;
...
declare class HeadlessB2BMagicLinksClient implements IHeadlessB2BMagicLinksClient {
    ...
    private _config;
    private dfpProtectedAuth;
    constructor(_networkClient: INetworkClient, _subscriptionService: IB2BSubscriptionService, _pkceManager: IPKCEManager, _passwordResetPKCEManager: IPKCEManager, _config?: DynamicConfig$3, dfpProtectedAuth?: IDFPProtectedAuthProvider);
    private getCodeChallenge;
    private handlePKCEForAuthenticate;
    email: {
        invite: (data: B2BMagicLinksInviteOptions) => Promise<B2BMagicLinksInviteResponse>;
    ...
    authenticate: (data: B2BMagicLinksAuthenticateOptions) => Promise<(Omit<B2BAuthenticateResponse, "member_session"> & {
        member_session: MemberSession;
        member_authenticated: true;
        intermediate_session_token: "";
        mfa_required: null;
        ...
        method_id: string;
    }) | (Omit<B2BAuthenticateResponse, "member_session"> & {
        member_session: null;
        member_authenticated: false;
        intermediate_session_token: string;
        mfa_required: MfaRequired | null;
...
declare class HeadlessB2BSelfClient implements IHeadlessB2BSelfClient {
    ...
    private _apiNetworkClient;
    private _subscriptionService;
    constructor(_networkClient: INetworkClient, _apiNetworkClient: INetworkClient, _subscriptionService: IB2BSubscriptionService);
    get: () => Promise<Member | null>;
    getSync: () => Member | null;
    getInfo: () => MemberInfo;
    onChange: (callback: B2BMemberOnChangeCallback) => UnsubscribeFunction;
...
declare class HeadlessB2BSSOClient implements IHeadlessB2BSSOClient {
    ...
    constructor(_networkClient: INetworkClient, _subscriptionService: IB2BSubscriptionService, _pkceManager: IPKCEManager, _dynamicConfig: DynamicConfig$4, _config: Config$0, dfpProtectedAuth: IDFPProtectedAuthProvider);
...
declare class HeadlessB2BSCIMClient implements IHeadlessB2BSCIMClient {
    protected _networkClient: INetworkClient;
    protected _subscriptionService: IB2BSubscriptionService;
...
declare class HeadlessB2BOAuthClient implements IHeadlessB2BOAuthClient {
    ...
    protected dfpProtectedAuth: IDFPProtectedAuthProvider;
    constructor(_networkClient: INetworkClient, _subscriptionService: IB2BSubscriptionService, _pkceManager: IPKCEManager, _dynamicConfig: DynamicConfig$5, _config: Config$1, dfpProtectedAuth: IDFPProtectedAuthProvider);
...
declare class HeadlessB2BPasswordsClient implements IHeadlessB2BPasswordClient {
    ...
    private _config;
    private dfpProtectedAuth;
    constructor(_networkClient: INetworkClient, _subscriptionService: IB2BSubscriptionService, _pkceManager: IPKCEManager, _config: DynamicConfig$6, dfpProtectedAuth: IDFPProtectedAuthProvider);
    private getCodeChallenge;
    authenticate(options: B2BPasswordAuthenticateOptions): Promise<B2BPasswordAuthenticateResponse>;
    resetByEmailStart(options: B2BPasswordResetByEmailStartOptions): Promise<B2BPasswordResetByEmailStartResponse>;
    discovery: {
...
declare class HeadlessB2BTOTPsClient implements IHeadlessB2BTOTPsClient {
    private _networkClient;
    private _subscriptionService;
    private dfpProtectedAuth;
    constructor(_networkClient: INetworkClient, _subscriptionService: IB2BSubscriptionService, dfpProtectedAuth: IDFPProtectedAuthProvider);
...
declare class HeadlessB2BRecoveryCodesClient implements IHeadlessB2BRecoveryCodesClient {
    private _networkClient;
    private _subscriptionService;
    private dfpProtectedAuth;
    constructor(_networkClient: INetworkClient, _subscriptionService: IB2BSubscriptionService, dfpProtectedAuth: IDFPProtectedAuthProvider);
    recover(data: RecoveryCodeRecoverOptions): Promise<RecoveryCodeRecoverResponse>;
    rotate(): Promise<RecoveryCodeRotateResponse>;
    get(): Promise<RecoveryCodeGetResponse>;
}
type CachedConfig = {
...
declare class HeadlessB2BRBACClient implements IHeadlessB2BRBACClient {
    ...
    constructor(cachedConfig: CachedConfig, dynamicConfig: DynamicConfig$7, _subscriptionService: IB2BSubscriptionService);
    allPermissions<Permissions extends Record<string, string>>(): Promise<PermissionsMap<Permissions>>;
...
declare class StateChangeClient<T> {
    ...
    constructor(_subscriptionService: ISubscriptionService<T | null>, emptyState: T);
