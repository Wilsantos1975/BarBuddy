          ...
          while (1) switch (_context23.prev = _context23.next) {
            ...
            case 8:
              ...
              if (!!(options === null || options === void 0 ? void 0 : options.forceClear)) {
                this._subscriptionService.destroyState();
              } else if (ui.UNRECOVERABLE_ERROR_TYPES.includes(_context23.t0.error_type)) {
                this._subscriptionService.destroyState();
              }
              throw _context23.t0;
            case 12:
        ...
        return _regeneratorRuntime().wrap(function _callee24$(_context24) {
          while (1) switch (_context24.prev = _context24.next) {
            ...
            case 13:
              ...
              return _context24.abrupt("return", this.authenticate(options));
            case 17:
              if (ui.UNRECOVERABLE_ERROR_TYPES.includes(_context24.t0.error_type)) {
        ...
        return _regeneratorRuntime().wrap(function _callee112$(_context112) {
          while (1) switch (_context112.prev = _context112.next) {
            ...
            case 8:
              ...
              if (!!(options === null || options === void 0 ? void 0 : options.forceClear)) {
                this._subscriptionService.destroyState();
              } else if (ui.UNRECOVERABLE_ERROR_TYPES.includes(_context112.t0.error_type)) {
                this._subscriptionService.destroyState();
              }
        ...
        return _regeneratorRuntime().wrap(function _callee114$(_context114) {
          while (1) switch (_context114.prev = _context114.next) {
            ...
            case 13:
              ...
              return _context114.abrupt("return", this.authenticate(options));
            case 17:
              if (ui.UNRECOVERABLE_ERROR_TYPES.includes(_context114.t0.error_type)) {
                this._subscriptionService.destroySession();
              }
